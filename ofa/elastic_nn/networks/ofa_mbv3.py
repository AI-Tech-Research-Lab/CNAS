...
from ofa.imagenet_codebase.networks.mobilenet_v3 import MobileNetV3, MobileInvertedResidualBlock, EEMobileNetV3, QuantMobileNetV3
...
class OFAQuantMobileNetV3(QuantMobileNetV3):
    ...
    def config(self):
        return {
            'name': OFAQuantMobileNetV3.__name__,
            'bn': self.get_bn_param(),
            'first_conv': self.first_conv.config,
            'blocks': [
                block.config for block in self.blocks
    ...
    def get_active_net_config(self):
        ...
        return {
            'name': QuantMobileNetV3.__name__,
            'bn': self.get_bn_param(),
            'first_conv': first_conv_config,
            'blocks': block_config_list,
            'final_expand_layer': final_expand_config,
