...
if __name__ == "__main__":
    ...
    if (os.path.exists(os.path.join(args.output_path,'ckpt.pth'))):
        ...
        backbone, optimizer = load_checkpoint(backbone, optimizer, os.path.join(args.output_path,'ckpt.pth'))
    ...
    backbone, classifiers, res = get_eenn(supernet=supernet_path, n_classes=args.n_classes,
                                        get_binaries=get_binaries,
                                        fix_last_layer=fix_last_layer,
                                        subnet_path=model_path,
                                        pretrained=args.pretrained
                                        )
