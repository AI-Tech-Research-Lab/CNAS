...
python cnas.py --sec_obj avg_macs --resume results/search_nachos_noconstraints_$dataset/iter_0   \
              ...
              --save results/search_nachos_noconstraints_$dataset --iterations 10 \
