...
python msunas.py --resume ../benchmarks/tiny_ml/search-cifar10-mbv3-w1.0-2022-03-23/iter_0 --sec_obj params \
              ...
              --save ../results/search-cifar10-mbv3-w1.0 --iterations 30 --vld_size 5000 \
