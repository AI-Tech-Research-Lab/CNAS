...
python adaptive_train_cifar.py --data ../data/cifar10 --dataset cifar10 \
    ...
    --initial-checkpoint1 ../results/20221220-104528cifar10adapt_tinynsganet40/net_flops@7.config \
    --initial-checkpoint2 ../results/20221220-104528cifar10adapt_tinynsganet40/net_flops@23.config \
