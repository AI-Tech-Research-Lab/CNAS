...
python msunas.py --resume ../results/entropic-mbv3-$dataset-$optim-$first_obj-$sec_obj-max$pmax-alpha$alpha-sigma$sigma-ep$n_epochs-multires-balance/iter_${resume_iter} \
        --n_gpus 1 --gpu 1 --gpu_list $gpu --n_workers 4 \
