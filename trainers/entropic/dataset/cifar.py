...
class Cifar:
    def __init__(self, batch_size, threads, data_path):
    ...
    def _get_statistics(self):
        train_set = torchvision.datasets.CIFAR10(root=self.data_path, train=True, download=True, transform=transforms.ToTensor())
